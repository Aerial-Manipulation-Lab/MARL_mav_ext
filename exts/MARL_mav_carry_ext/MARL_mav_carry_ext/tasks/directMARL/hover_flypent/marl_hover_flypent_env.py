...
from .marl_hover_flypent_env_cfg import MARLHoverFlypentEnvCfg


class MARLHoverFlypentEnv(DirectMARLEnv):
    cfg: MARLHoverFlypentEnvCfg

    def __init__(self, cfg: MARLHoverFlypentEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _get_observations(self) -> dict[str, torch.Tensor]:
        ...
        if self.cfg.partial_obs:
            ...
            obs_falcon5 = self._observation_buffers["falcon5"].buffer.reshape(self.num_envs, -1)
