...
class ActionsCfg:
    ...
    low_level_action: mdp.LowLevelActionCfg_spline = mdp.LowLevelActionCfg_spline(
...
@configclass
class HoverEnvCfg_llc_spline(ManagerBasedRLEnvCfg):
