...
class ActionsCfg:
    ...
    low_level_action: mdp.LowLevelActionCfg = mdp.LowLevelActionCfg(
        asset_name="robot", body_name="Falcon.*rotor_.*", debug_vis=False, control_mode = 'geometric',
    )
...
class CurriculumCfg:
    ...
    range_term = CurrTerm(func = mdp.modify_command_range, params = {"term_name": "pose_command", "range": mdp.UniformPoseCommandGlobalCfg.Ranges(
            pos_x=(-2.0, 2.0),
            pos_y=(-2.0, 2.0),
            pos_z=(0.5, 2.5),
            roll=(-math.pi/4, math.pi/4),
